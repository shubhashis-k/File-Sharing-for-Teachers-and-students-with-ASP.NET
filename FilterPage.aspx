<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FilterPage.aspx.cs" Inherits="FilterPage" %>
...
<body class="metro">
    ...
    <div>
        ...
        <div style="width:200px; margin-top:100px">
            <nav class="vertical-menu">
                <ul>
                    ...
                    <li>
                         <asp:Button ID="FilterButton" class="info" runat="server" Text="Filter" Height="44px" Width="145px" OnClick="FilterButton_Click" />
                    </li>
                    <li>
        ...
        <div style="position:absolute; margin-top:-200px; margin-left:250px; ">
            ...
            <asp:GridView ID="FilterGridView" runat="server" AutoGenerateColumns = "False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="true" PageSize ="10"  OnPageIndexChanging ="FilterGridView_PageIndexChanging">
        ...
        <div style="position:absolute; margin-top:-230px; margin-left:250px;">
            <asp:Button ID="MakeTeacherButton" runat="server" class="info" Text="Make Teacher" Width="162px" OnClick="MakeTeacherButton_Click"  />
        </div>

        <div style="position:absolute; margin-top:-230px; margin-left:450px;">
            <asp:Button ID="MakeStudentButton" runat="server" class="info" Text="Make Student" Width="162px" OnClick="MakeStudentButton_Click" />
        </div>

        <div style="position:absolute; margin-top:190px; margin-left:250px; top: 382px; left: -4px;">
