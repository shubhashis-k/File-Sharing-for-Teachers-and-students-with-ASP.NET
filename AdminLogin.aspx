<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="Log" %>
...
<body class="metro">
    ...
    <form id="form1" runat="server">
        ...
        <h1 style="text-align:center">Log in as Administrator of Group</h1>
        <div class="loginholder">
            <div class="input-control text" style="margin-top:140px">
                <asp:TextBox ID="AdminNameBox" runat="server" value="" placeholder="Enter Admin Name" ></asp:TextBox>
                <asp:TextBox ID="AdminPasswordBox" runat="server" placeholder="Enter Admin Password" TextMode="Password"></asp:TextBox>
            </div>
            <div style="margin-top:10px">
                <asp:CheckBox ID="RememberMe" runat="server" Text="" /><asp:Label ID="Labl1" runat="server" Text="Remember Me"></asp:Label>
            </div>
